...
const FormUniqueOption = ({  icon,  isSelected,  name,  price,  value,  setFunction}: FormUniqueOptionProps) => {
  return (
    <div className={`flex px-4 pt-[14px] pb-[18px] justify-start items-center ${isSelected ? 'border-purplish-blue bg-very-light-gray' : 'border-light-gray bg-white'} rounded-lg border-[1px] gap-[14px] cursor-pointer md:flex-col md:grow md:basis-[137px] md:h-[160px] md:justify-between md:items-start md:pt-5 md:hover:border-purplish-blue `} onClick={() => setFunction(value)}>
