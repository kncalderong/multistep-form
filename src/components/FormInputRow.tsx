  ...
  return (
    <div className='flex flex-col items-start relative' >
      ...
      <input type={type} value={value} name={name} onChange={(e) => {
        ...
        ref={refHook}
        placeholder={placeHolder} className={`border-light-gray rounded-[4px] px-4 py-2 border-[1px] mt-1 w-full ${showAlert ? 'focus:border-strawberry-red' : 'focus:border-purplish-blue'} focus-visible:outline-none text-marine-blue text-[15px] placeholder-cool-gray placeholder:font-medium`} />
      {showAlert && (
