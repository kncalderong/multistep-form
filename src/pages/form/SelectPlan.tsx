  ...
  return (
    <div className='flex flex-col grow md:items-center' >
        ...
        <div className='bg-white py-8 px-6 w-full rounded-[10px] mt-[-89px] md:mt-0 md:p-0 md:w-[450px]' >
          <form className='flex flex-col'>
            ...
            <div className='flex h-12 rounded-lg bg-very-light-gray py-[14px] gap-6 justify-center items-center' >
              <p className='text-marine-blue font-medium text-sm md:font-bold' >Monthly</p>
      ...
      <div className='flex justify-between p-4 items-center md:w-[450px] md:px-0'>
        <div className='text-sm text-cool-gray cursor-pointer md:w-[123px] md:h-[48px] md:text-base md:rounded-lg md:hover:text-marine-blue md:hover:font-bold' onClick={() => runValidations('/')} >Go Back</div>
        <div className='w-[97px] h-[40px] bg-marine-blue text-white text-sm flex justify-center items-center rounded-[4px] cursor-pointer md:w-[123px] md:h-[48px] md:text-base md:rounded-lg' onClick={() => runValidations('/adds-on')} >Next Step</div>
      </div>
    </div>
  )
}
